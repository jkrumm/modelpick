...
export const IU_CATALOG: ModelInsert[] = [
  ...
  {
    // display_name corrected by hand: portal parser misattributed a "Gemini 2.5 Pro" row.
    id: "gemini-2.5-flash-native-audio-preview-12-2025",
    provider: "google",
    family: null,
    modality: "tts",
    display_name: "Gemini 2.5 Flash Native Audio (12-2025)",
    context_window: null,
    iu_listed: true,
  },
  {
  ...
  {
    // display_name corrected by hand: the portal HTML parser misattributed a
    // neighbouring "Gemini 3.1 Pro" row to this TTS id.
  ...
  },
  {
    ...
    family: null,
    modality: "stt",
    display_name: "Voxtral Mini Transcribe 2507",
    context_window: null,
    iu_listed: true,
  },
  {
